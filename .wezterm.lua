...
config.window_frame = {
    ...
    active_titlebar_bg = wezterm.color.parse("rgba(12, 11, 15, 1)"),  -- 0.5 is the alpha value for transparency
    inactive_titlebar_bg = wezterm.color.parse("rgba(12, 11, 15,1 )"),  -- 0.5 is the alpha value for transparency
}
